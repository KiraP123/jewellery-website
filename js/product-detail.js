        ...
        <div class="col-6 col-md-3 mb-3">
            <div class="card h-100 border-0 shadow-sm rounded-4 text-center">
                <a href="product-detail.html?id=${p.id}">                    
                 <img src="${p.image && p.image.startsWith('http') ? p.image : `${BASE_URL}/images/${p.image}`}" class="card-img-top p-2" style="height:120px; object-fit:contain;" onerror="this.src='https://via.placeholder.com/300'">
                </a>
