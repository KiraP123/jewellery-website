...
window.addToCart = function(productId, selectedSize) {
    ...
    if (product) {
        ...
        if (existingItem) {
            ...
            return; // ⛔ STOP: Yahan se code khatam. Refresh hone par quantity nahi badhegi.
        } else {
            // Naya item hai toh hi push hoga
            cart.push({
                ...product,
                quantity: 1,
...
function updateCartUI() {
    ...
    cartBody.innerHTML = cart.map((item, index) => {
        ...
        // Calculations (Qty ke saath multiply ho raha hai)
        ...
        <div class="card mb-3 border-0 shadow-sm rounded-4 overflow-hidden position-relative animate__animated animate__fadeIn">
            ...
            <div class="card-body p-3">
                <div class="form-check m-0 mb-2">
                    ...
                    <label class="form-check-label small fw-bold text-muted" for="check-${index}" style="font-size: 9px;">SELECT ITEM</label>
                </div>

                <div class="row g-3 align-items-center">
                  <div class="col-4 col-md-2 text-center">
                               <img src="http://localhost:3000/images/${item.image}" class="rounded border me-3" style="width:65px; height:65px; object-fit:contain;">
                    ...
                    <div class="col-8 col-md-6">
                        <div class="d-flex flex-column h-100">
                            ...
                            <div class="mb-2">
                                <span class="badge text-dark border fw-medium" style="font-size: 10px; background-color: #fff9e6; color: #b8860b !important;">
...
<div class="input-group shadow-sm rounded-pill overflow-hidden" 
     style="width: 100px !important; display: flex !important; flex-direction: row !important; border: 1px solid #eee; background: #fff; height: 30px;">
    
    <button type="button" class="btn btn-white border-0" 
            onclick="window.changeQty(${index}, -1)" 
            style="width: 30px; padding: 0; display: flex; align-items: center; justify-content: center; box-shadow: none;">
        <i class="bi bi-dash"></i>
    </button>
    
    <input type="text" class="form-control text-center border-0 fw-bold bg-white p-0" 
           value="${qty}" readonly 
           style="font-size: 13px; width: 40px !important; pointer-events: none; box-shadow: none;">
    ...
    <button type="button" class="btn btn-white border-0" 
        ...
        <i class="bi bi-plus"></i>
                    ...
                    <div class="col-12 col-md-4 text-end">
                        ...
                        <span class="fw-bolder text-dark" style="font-size: 1.2rem;">₹${itemGoldTotal.toLocaleString('en-IN')}</span>
                    </div>
                </div>
            </div>
        </div>
